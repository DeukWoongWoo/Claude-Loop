...
REPO_URL="https://raw.githubusercontent.com/DeukWoongWoo/claude-loop/main"

echo "🔂 Installing Claude Loop..."
...
if ! curl -fsSL "$REPO_URL/claude_loop.sh" -o "$INSTALL_DIR/$BINARY_NAME"; then
...
echo ""
echo "For more information, visit: https://github.com/DeukWoongWoo/claude-loop"
